        ...
        <div class="row">
            ...
            <div class="col-md-8 text-center">
                <form class="col-md-12" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Editer le profil') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Nom & Prénom') }}</label>
                                <div class="col-md-9">
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Sauvegarder les modifications') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form class="col-md-12" action="{{ route('profile.password') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Changer le mot de passe') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Ancien mot de passe') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Nouveau mot de passe') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Confirmer le mot de passe') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Sauvergarder les modifications') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
